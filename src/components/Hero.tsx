    ...
    <section className="section-padding" style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '4rem', marginTop: '-5vh' }}>
        ...
        <div style={{ flex: '1 1 500px', maxWidth: '700px' }}>
          ...
          >
            <p className="text-body" style={{ color: '#888', margin: 0 }}>
            ...
            <div style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem' }}>
              {/* Botón Principal: GitHub (Glass con acento Cyan) */}
              ...
              }} className="hover-target" onMouseOver={(e) => { e.currentTarget.style.background = 'rgba(6,182,212,0.2)'; e.currentTarget.style.transform = 'scale(1.05)'; }} onMouseOut={(e) => { e.currentTarget.style.background = 'rgba(6, 182, 212, 0.1)'; e.currentTarget.style.transform = 'scale(1)'; }}>
              ...
              {/* Botón Secundario: LinkedIn (Glass neutro) */}
              <a href="https://www.linkedin.com/in/martín-aburto-méndez-369326291" target="_blank" rel="noreferrer" style={{ 
                ...
                fontWeight: 500, fontSize: '0.85rem', transition: 'all 0.2s',
                fontFamily: 'Inter, sans-serif'
              }} className="hover-target" onMouseOver={(e) => { e.currentTarget.style.background = 'rgba(255,255,255,0.1)'; e.currentTarget.style.transform = 'scale(1.05)'; }} onMouseOut={(e) => { e.currentTarget.style.background = 'rgba(255,255,255,0.03)'; e.currentTarget.style.transform = 'scale(1)'; }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
